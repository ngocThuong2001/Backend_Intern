...
public class DonationReturnRequest {
	...
	public DonationReturnRequest(String vnp_Amount, String vnp_BankCode, String vnp_BankTranNo, String vnp_CardType,
	...
	public String toString() {
		return "DonationReturnRequest [vnp_Amount=" + vnp_Amount + ", vnp_BankCode=" + vnp_BankCode
				+ ", vnp_BankTranNo=" + vnp_BankTranNo + ", vnp_CardType=" + vnp_CardType + ", vnp_OrderInfo="
				+ vnp_OrderInfo + ", vnp_PayDate=" + vnp_PayDate + ", vnp_ResponseCode=" + vnp_ResponseCode
				+ ", vnp_TmnCode=" + vnp_TmnCode + ", vnp_TransactionNo=" + vnp_TransactionNo
